...
# 初始化 DeepSeek 客户端
client = OpenAI(api_key="sk-2e708e0f12774604a1d75ba9db29a9ae", base_url="https://api.deepseek.com")

# 文件路径
csv_file = r"E:\Jupyter_files\LLM_sh_transformed.csv"
output_file = r"E:\Jupyter_files\output_sh1.csv"
